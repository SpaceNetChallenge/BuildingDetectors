...
public class BuildingDetectorTester {
	...
	public static void main(String[] args) {
		...
		*/
		...
		File folder3band = new File(dataFolder, "3band");
		File folder8band = new File(dataFolder, "8band");
	...
	public void runTest(File rfBuilding, File rfBorder, File rfDist, File rfPolyMatch, File folder3band, File folder8band, File answerFile, boolean isLocal) {
		...
		writeAnswer(answerFile, answers.size() > 1000);
	}
...
//if (j != 9) continue;
							// id = "AOI_1_RIO_img4891";
							System.err.println("\t" + j + "\t" + id);
	...
	private void processImage(String imageId, File folder3band, File folder8band) {
		try {
			File imageFile3band = new File(folder3band, "3band_" + imageId + ".tif");
			File imageFile8band = new File(folder8band, "8band_" + imageId + ".tif");
