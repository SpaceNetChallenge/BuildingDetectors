...
def evalfunction((image_id, test_polys, truth_polys, truth_index)):
    ...
    #print('evalfunction,image_id{}'.format(image_id))
    #print('evalfunction,test_polys{}'.format(test_polys))
    #print('evalfunction,truth_polys{}'.format(truth_polys))
    #print('evalfunction,truth_index{}'.format(truth_index))
