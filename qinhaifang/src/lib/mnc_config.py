...
__C.USE_MSS_DATA = False
__C.MSS_DATA_CHANNELS = 8
__C.MSS_DATA_MEANS = np.array([[[128.00,128.00,128.00,128.00,128.00,128.00,128.00,128.00]]])
...
# Data directory
__C.DATA_DIR = '/mnt/lustre/licong/train_test/spacenet/MNC_folder/MNC_simple_v1_x1data/spaceNet_data'
...
__C.TRAIN.SNAPSHOT_ITERS = 1000000
